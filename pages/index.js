...
export default function Home() {
  ...
  // console.log(dataGui);
  // console.log(dataNhan);

  if (dataGui.length != 0 && dataNhan.length != 0) {
  ...
  return (
    <div>
      ...
      <div>
        <h3 style={{ marginLeft: 80 }}><i className="fa-solid fa-users"></i> My friend</h3>
        {data.length > 0 ? (
      ...
      {usernameFriend ? (
        <div className={styles.boxMessage}>
          ...
          {/* <div className={styles.boxMessage_body}>
            {dataGui.map((item, index) => {
              return (
                <div key={index} className={styles.me}>
                  <p>{item.date}</p>
                  <li>
                    {item.noiDung}
                  </li>
